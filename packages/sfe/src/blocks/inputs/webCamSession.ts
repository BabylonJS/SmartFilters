...
export class WebCamSession implements IDisposable {
    ...
    /**
     * Creates a new WebCamSession
     * @param engine - The engine to use
     * @param textureOutput - The texture output to use
    ...
    /**
     * Disposes the WebCam session, stopping the media stream and disposing of the texture.
     */
    public dispose(): void {
