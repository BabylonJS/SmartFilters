...
import { babylonDemoEffects, babylonDemoTransitions, babylonDemoUtilities } from "./blocks/blockNamespaces";
...
export async function blockFactory(
    ...
    const deserializer = deserializers.get([serializedBlock.blockType, serializedBlock.namespace]);
    if (deserializer) {
...
type BlockNamespaceAndType = [string, Nullable<string>];
/**
 ...
 */
const deserializers = new Map<BlockNamespaceAndType, DeserializeBlockV1>();

// Deserializing blocks defined by serialized definitions
// ------------------------------------------------------
deserializers.set(
    [BlockNames.tint, babylonDemoEffects],
...
deserializers.set(
    [BlockNames.pixelateAndDesaturate, babylonDemoEffects],
    async (
        smartFilter: SmartFilter,
        serializedBlock: ISerializedBlockV1,
        engine: ThinEngine,
...
// -----------------------------------------
deserializers.set(
    [BlockNames.pixelate, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.blackAndWhite, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.exposure, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.contrast, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.desaturate, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.posterize, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.kaleidoscope, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.greenScreen, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.glass, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.frame, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.blackAndWhiteAndBlur, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.glitch, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.mask, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.vhsGlitch, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.softThreshold, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.sketch, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.spritesheet, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.premultiplyAlpha, babylonDemoUtilities],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.blur, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.directionalBlur, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.composition, babylonDemoEffects],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.tile, babylonDemoTransitions],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
...
deserializers.set(
    [BlockNames.wipe, babylonDemoTransitions],
    async (smartFilter: SmartFilter, serializedBlock: ISerializedBlockV1) => {
