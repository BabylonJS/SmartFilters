...
import { shaderProgram, uniforms } from "../effects/heartsBlock.shader";
...
export class HeartsBlock extends ShaderBlock {
     ...
     */
    public static override ClassName = "HeartBlock";
    ...
    public getShaderBinding(): ShaderBinding {
        ...
        return new HeartsShaderBinding(this, input, time);
    }
}
