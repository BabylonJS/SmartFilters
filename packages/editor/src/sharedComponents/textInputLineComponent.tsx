...
export interface ITextInputLineComponentProps {
    ...
    disabled?: boolean;
    allowEditingDuringFailedValidation?: boolean;
}
...
export class TextInputLineComponent extends react.Component<
    ITextInputLineComponentProps,
    { value: string; dragging: boolean; validationFailedButUserStillAllowedToEdit: boolean }
> {
    ...
    constructor(props: ITextInputLineComponentProps) {
        ...
        this.state = {
            value:
                (this.props.value !== undefined ? this.props.value : this.props.target[this.props.propertyName!]) ||
                emptyValue,
            dragging: false,
            validationFailedButUserStillAllowedToEdit: false,
        };
    }
    ...
    override shouldComponentUpdate(
        nextProps: ITextInputLineComponentProps,
        nextState: { value: string; dragging: boolean }
    ) {
    ...
    updateValue(value: string, valueToValidate?: string) {
        ...
        if (this.props.validator && valueToValidate) {
            if (this.props.validator(valueToValidate) == false) {
                if (this.props.allowEditingDuringFailedValidation) {
                    shouldUpdateTarget = false;
                    this.setState({ validationFailedButUserStillAllowedToEdit: true });
                } else {
                    value = store;
                }
            } else {
    ...
    override render() {
        ...
        const placeholder =
            this.state.value === conflictingValuesPlaceholder
